        ...
        >
            <article className="relative h-full flex flex-col p-4 rounded-2xl bg-card/60 backdrop-blur-sm border border-border transition-all duration-300 hover:bg-card hover:-translate-y-2 hover:border-indigo-500/30 hover:shadow-[0_20px_40px_-10px_rgba(99,102,241,0.2)]">
                ...
                <div className="relative w-full aspect-2/3 mb-5">
                    ...
                    {/* Delete Ribbon/Button overlay  */}
                    <button 
                        onClick={handleDelete}
                        disabled={isDeleting}
                        className="absolute -top-3 -right-3 p-2.5 rounded-full bg-red-500/90 text-white backdrop-blur-md shadow-lg opacity-0 group-hover:opacity-100 -translate-y-2 group-hover:translate-y-0 transition-all duration-300 hover:scale-110 hover:bg-red-600 focus:outline-none z-10"
                        title="Delete Book"
                    >
